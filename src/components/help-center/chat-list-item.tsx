...
import { MessageStatusIcon } from "@/components/help-center/message-status-icon";
      ...
      <Avatar className="overflow-visible md:size-10">
        ...
        <AvatarBadge
          className={cn("size-2.5", {
            "bg-green-500": chat.user?.online_status === "success",
            "bg-yellow-500": chat.user?.online_status === "warning",
